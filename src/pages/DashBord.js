  ...
  return (
    <div>
      ...
      <section className="h-[100vh] p-5">
        ...
        <div className="w-full bg-slate-400  mt-4">
          ...
          <div className="w-full bg-slate-300 p-2 flex shadow-inner gap-5 justify-between ">
            <div className="w-32 flex flex-wrap">
              <h1 className=" font-robotoflex text-sm">Ashish singh</h1>
            </div>
            <div className="w-32 flex flex-wrap">
              <h1 className=" font-robotoflex text-sm">Ashish@gmail.com</h1>
            </div>
            <div className="w-32 flex flex-wrap">
              <h1 className=" font-robotoflex text-sm">23/12/2023</h1>
            </div>
            <div className="w-32 flex flex-wrap">
              <Link to={"/profile2"}>
                {" "}
